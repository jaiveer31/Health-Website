...
if (isset($_POST['submit'])) {
    //variables
    $doctorFirstName = $_POST['patientFirstName'];
    $doctorLastName = $_POST['patiientLastName'];
    $doctorPhone = $_POST['patientPhone'];
    $doctorEmail = $_POST['patientEmail'];
    $doctorAddress = $_POST['patientAddress'];

    $res = mysqli_query($con, "UPDATE patient SET patientFirstName='$patientFirstName', patientLastName='$patientLastName', patientPhone='$patientPhone', patientEmail='$patientEmail', patientAddress='$patientAddress' WHERE icPatient=" . $_SESSION['patientSession']);
