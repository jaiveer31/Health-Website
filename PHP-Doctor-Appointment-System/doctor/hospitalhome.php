    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="doctordashboard.php">MG Hospital</a>
            </div>
            <!-- Top Menu Items -->
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> MG Hospital<b class="caret"></b></a>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="addschedule.php"><i class="fa fa-fw fa-table"></i> Add Patient</a>
                    </li>
                    <li>
                        <a href="patientlist.php"><i class="fa fa-fw fa-edit"></i> Patient Record</a>
                    </li>
                    <li>
                        <a href="hodpitaldischarge.php"><i class="fa fa-fw fa-edit"></i> Discharge</a>
                    </li>
                    <li>
                        <a href="hospitalbed.php"><i class="fa fa-fw fa-edit"></i> Bed Status</a>
                    </li>
                    <li>
                        <a href="hospitalpolicy.php"><i class="fa fa-fw fa-edit"></i> Policy</a>
                    </li>
                    <li>
                        <a href="hospitalecard.php"><i class="fa fa-fw fa-edit"></i> E-Card</a>
                    </li>
            ...
            <div class="container-fluid">
                ...
                <div class="panel panel-primary filterable">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">Patient Record</h3>
