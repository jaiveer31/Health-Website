                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="View Profile" disabled></th>
                            ...
                            while ($patientRow = mysqli_fetch_array($result)) {
                                ...
                                echo "<form method='get' action='pat.php'>";
                                echo "<tbody>";
                                echo "<tr>";
                                echo "<td>" . $patientRow['icPatient'] . "</a></td>";
                                ...
                                echo "<td><a href='pat.php?id=" . $patientRow['icPatient'] . "'><input type='submit' name='viewid' value='View'></a></td>";
